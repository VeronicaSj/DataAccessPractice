 ...
 * @author veron
 */
public class ClassFileEj3LecturaFicherosSecuencialAccDatVeronicaSanchezNB {
    private static FileManager fileMan; //controlador del fileSystem
    ...
    public static void main(String[] args) {
        ...
        if(userFileSystemLocation != null){//si se ha dado una localizacion 
            fileMan = new FileManager(userFileSystemLocation);
